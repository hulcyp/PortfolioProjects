...
namespace pdh
{
	...
	public:
		...
		static Real randInRange( Real min, Real max );
	...
	template< typename Real >
	Real MathFuncs<Real>::randInRange( Real min, Real max )
	{
		const Real r = rand() / static_cast< Real >( RAND_MAX );
	...
	template< typename Real >
	const Real MathFuncs<Real>::PI = 3.141592654;
	template< typename Real >
