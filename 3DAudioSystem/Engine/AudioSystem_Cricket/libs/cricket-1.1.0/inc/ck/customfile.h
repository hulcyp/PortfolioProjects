...
/** Callback type for opening files using a CkCustomFile instance.
  Should return an instance of a CkCustomFile subclass, or NULL to open the
  file with the default handler. */
typedef CkCustomFile* (*CkCustomFileHandler)(const char* path, CkPathType);

/** Set the file handler. 
  Set it to NULL to use the default handler. */
void CkSetCustomFileHandler(CkCustomFileHandler);
