...
//-----------------------------------------------------
AStarMinHeap::HeapError AStarMinHeap::pushElement( float F, MapTile mapTile )
{
...
//-----------------------------------------------------
AStarMinHeap::HeapError AStarMinHeap::updateElement( float oldF, float newF, MapTile mapTile )
{
	if( m_nextElementIndex == 0 )
		return EMPTY;
...
//-----------------------------------------------------
bool AStarMinHeap::findAndUpdateElement( int elementIndex, float oldF, float newF, MapTile mapTile )
{
