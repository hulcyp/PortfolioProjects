...
void					FatalXMLError_IllegalElement( const ResourceStream& resourceStream, XMLNode illegalElement, const std::string& optionalListOfLegalElementNames = "" );
...
{
	// FatalError( "Operation unsupported", Stringf( "Operation > not supported on this Vector2" ) );
	return false;
}
...
{
	// FatalError( "Operation unsupported", Stringf( "Operation > not supported on this IntVector2" ) );
	return false;
}
...
{
	// FatalError( "Operation unsupported", Stringf( "Operation > not supported on this Rgba" ) );
	return false;
}
