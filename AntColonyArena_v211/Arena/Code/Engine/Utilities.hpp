...
//
template< typename T_TypeContainedByPointer >
void DeleteAllItems( std::vector< T_TypeContainedByPointer* >& container );

template< typename T_TypeContainedByPointer >
void DeleteAllItems( std::list< T_TypeContainedByPointer* >& container );

template< typename T_MapValueType, typename T_TypeContainedByPointer >
void DeleteAllItems( std::map< T_MapValueType, T_TypeContainedByPointer* >& container );
...
//-----------------------------------------------------------------------------------------------
template< typename T_TypeContainedByPointer >
inline void DeleteAllItems( std::vector< T_TypeContainedByPointer* >& container )
{
	std::vector< T_TypeContainedByPointer* >::iterator iter;
	for( iter = container.begin(); iter != container.end(); ++ iter )
	{
		T_TypeContainedByPointer* object = *iter;
		delete object;
	}
...
//-----------------------------------------------------------------------------------------------
template< typename T_TypeContainedByPointer >
inline void DeleteAllItems( std::list< T_TypeContainedByPointer* >& container )
{
	std::list< T_TypeContainedByPointer* >::iterator iter;
	for( iter = container.begin(); iter != container.end(); ++ iter )
	{
		T_TypeContainedByPointer* object = *iter;
		delete object;
...
//-----------------------------------------------------------------------------------------------
template< typename T_MapValueType, typename T_TypeContainedByPointer >
inline void DeleteAllItems( std::map< T_MapValueType, T_TypeContainedByPointer* >& container )
{
	std::map< T_MapValueType, T_TypeContainedByPointer* >::iterator iter;
	for( iter = container.begin(); iter != container.end(); ++ iter )
	{
		T_TypeContainedByPointer* object = iter->second;
		delete object;
	}
